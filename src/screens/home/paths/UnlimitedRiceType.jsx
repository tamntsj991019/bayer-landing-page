...
const FrameLeft = ({ srcImg, text }) => {
  ...
  return (
    ...
    >
      ...
      <div
        className={`absolute left-0 top-0 bg-[#2b66384d] ${height} `}
        style={{
          width: isHover ? 0 : 175,
          clipPath: isHover
      ...
      />
      <div
        className={`absolute left-0 top-0 bg-[#2b6638b3] ${height} `}
        style={{
          width: isHover ? 0 : 196,
          clipPath: isHover
            ? "polygon(0% 0%, 100% 0, 100% 100%, 0% 100%)"
      ...
      <div
        className={`absolute left-0 top-0 bg-[#00BBFE] ${height} `}
        style={{
          width: isHover ? 0 : 216,
          clipPath: isHover
...
const FrameRight = ({ srcImg, text }) => {
  ...
  return (
    ...
    >
      ...
      <div
        className={`absolute left-0 top-0 bg-[#ff31624d] ${height} `}
        style={{
          width: isHover ? 0 : 251,
          clipPath: isHover
            ? "polygon(0% 0%, 100% 0, 100% 100%, 0% 100%)"
      ...
      />
      <div
        className={`absolute left-0 top-0 bg-[#ff3162b3] ${height} `}
        style={{
          width: isHover ? 0 : 268,
          clipPath: isHover
            ? "polygon(0% 0%, 100% 0, 100% 100%, 0% 100%)"
      ...
      <div
        className={`absolute left-0 top-0 bg-[#10394F] ${height} `}
        style={{
          width: isHover ? 0 : 291,
          clipPath: isHover
            ? "polygon(99% 1%, 100% 0, 100% 100%, 99% 100%)"
