...
const Convenient = (props) => {
  return (
    <div className="mt-[3.6rem]">
      <Title text="Tiện lợi" />
      <div
        className="mb-[2.2rem] mt-[0.5rem] px-3 text-center text-[1.5rem]"
        style={{ color: Color.PrimaryText }}
      >
        <b className="mr-[0.5rem]">Phun tóe</b>
        <span className="font-light">
          khi mặt ruộng có mức nước 2 - 3 cm, không cần tháo nước ra và bơm nước
          vào. Giảm 50% thời gian phun và 50% lượng nước phun.
        </span>
      </div>
